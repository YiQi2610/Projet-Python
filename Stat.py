...
print(ip301)
print()
print("Les adresses IP qui ont le code de réponse 416:")
print(ip416)
print()
print("Les adresses IP qui ont le code de réponse 206:")
print(ip206)
print()
print("Les adresses IP qui ont le code de réponse 500:")
print(ip500)
